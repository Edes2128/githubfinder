...
const User = ({repos,getUserRepos,match}) => {
        ...
        useEffect(()=>{
            ...
            const {name,avatar_url,location,bio,blog,login,html_url,followers,following,company,public_repos,public_gists,hireable} = githubContext.user;
